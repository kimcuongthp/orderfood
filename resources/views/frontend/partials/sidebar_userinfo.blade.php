<div class="list-group">
    <a href="/userinfo" class="list-group-item waves-light"> <i class="fas fa-user"></i> {{ trans('frontend.userinfo') }}</a>
    ...
    <a href="/order-history" class="list-group-item waves-effect"><i class="fas fa-cart-arrow-down"></i> {{ trans('frontend.order_history') }}</a>
